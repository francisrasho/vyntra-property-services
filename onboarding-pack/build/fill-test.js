...
(async () => {
  ...
  ['doc_abn','doc_pli','doc_licence','doc_bank','doc_emergency',
   'agree_ica','agree_conduct','agree_payment','agree_safety','agree_conf','agree_privacy','agree_nonsolicit']
   .forEach(n => form.getCheckBox(n).check());
  const set = {full_name:'Jordan Blake', abn:'12 345 678 901', company_name:'Blake Maintenance Pty Ltd',
  ...
  console.log('filled.pdf written');
